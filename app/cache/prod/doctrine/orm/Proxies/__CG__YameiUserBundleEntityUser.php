...
namespace Proxies\__CG__\Yamei\UserBundle\Entity;

/**
 * THIS CLASS WAS GENERATED BY THE DOCTRINE ORM. DO NOT EDIT THIS FILE.
 */
class User extends \Yamei\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setCrtTime();
    }

    public function getCrtTime()
    {
        $this->__load();
        return parent::getCrtTime();
    }

    public function setUpdTime()
    {
        $this->__load();
        return parent::setUpdTime();
    }

    public function getUpdTime()
    {
        $this->__load();
        return parent::getUpdTime();
    }
    ...
    {
        return array('__isInitialized__', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'lastLogin', 'locked', 'expired', 'expiresAt', 'confirmationToken', 'passwordRequestedAt', 'roles', 'credentialsExpired', 'credentialsExpireAt', 'id', 'company', 'fullname', 'crt_time', 'upd_time');
    }
