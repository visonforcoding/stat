 ...
 */
class HttpUrlPath extends \Yamei\RecEyeBundle\Entity\HttpUrlPath implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'url_path', 'httpRequest');
    }
