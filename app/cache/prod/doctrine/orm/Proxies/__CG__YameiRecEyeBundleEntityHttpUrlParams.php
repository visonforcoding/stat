 ...
 */
class HttpUrlParams extends \Yamei\RecEyeBundle\Entity\HttpUrlParams implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setHttpRequest($httpRequest);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'url_params', 'httpRequest');
    }
