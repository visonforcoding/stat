$(document).ready(function(){
    ...
    $(".combobox input").focus(function(){   
        ...
        ci.focusout(function(){        
            setTimeout(function(){                 
                ci.parent('.combobox').find('ul').hide().find('li').show();
            }, 100);        
        });
        ...
        ci.keyup(function(){
            ...
            if(cb.hasClass('ws')){
                if($(this).val().length > 0){
                    cb.find('ul > li').hide();
                    cb.find("ul > li:containsi('"+$(this).val()+"')").show();        
                }else
                    cb.find('ul > li').show();
            }               
        });        
        
        cb.find('li').click(function(){                        
            if($(this).attr('data-val') != null)
                cb.find('input').val($(this).attr('data-val'));
            else
                cb.find('input').val($(this).html());                        
            cb.find('ul').hide().find('li').show();                                    
        });
